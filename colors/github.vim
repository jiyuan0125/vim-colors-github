...
let s:colors.yellow         = { 'gui': '#ffe17a', 'cterm': 230 } " github search
...
let s:colors.blue5          = { 'gui': '#add9f9', 'cterm': 153 } " visual selection
...
let s:colors.gutter     = s:lib.f6f8fa
let s:colors.bg         = s:lib.white
let s:colors.base4      = s:lib.numLighter
let s:colors.visualblue = s:colors.blue5
let s:colors.lightblue  = s:colors.blue4
let s:colors.lightblue_nr  = s:colors.blue2
...
call s:Col('Search', 'base0', 'yellow') " | call s:Attr('Search', 'bold')
call s:Col('IncSearch', 'grey2', 'base0') " | call s:Attr('IncSearch', 'bold')
...
call s:Col('Error', 'darkred', 'bg')
call s:Col('Title', 'purple') | call s:Attr('Title', 'bold')

call s:Col('VertSplit',    'grey0', 'bg')
call s:Col('LineNr',       'base4',  'gutter')
hi! link     SignColumn       LineNr
hi! link     EndOfBuffer      Normal
call s:Col('ColorColumn',  '',       'grey2')
call s:Col('CursorLineNR', 'base3',  'lightblue_nr')
call s:Col('CursorLine',   '',       'lightblue')
call s:Col('CursorColumn', '',       'lightblue')
call s:Col('QuickFixLine', '', 'blue3') | call s:Attr('QuickFixLine', 'bold')
call s:Col('qfLineNr', 'base3', 'gutter')

call s:Col('Folded',     'base3', 'lightorange') | call s:Attr('Folded', 'bold')
...
call s:Col('Pmenu',      'base0', 'grey1')
call s:Col('PmenuSel',   'overlay',  'base0') | call s:Attr('PmenuSel', 'bold')
...
call s:Col('TabLine',     'base3', 'grey1') | call s:Attr('TabLine', 'none')
call s:Col('TabLineFill', '', 'bg') | call s:Attr('TabLineFill', 'none')
call s:Col('TabLineSel',  'grey2', 'base0') | call s:Attr('TabLineSel', 'none')
...
" nvim :terminal mode
if has('nvim')
  "let g:terminal_color_0 = s:colors.base0.gui
  "let g:terminal_color_8 = s:colors.base3.gui

  "let g:terminal_color_1 = s:colors.darkred.gui
  "let g:terminal_color_9 = s:colors.red.gui

  "let g:terminal_color_2 = s:colors.green.gui
  "let g:terminal_color_10 = s:colors.boldgreen.gui

  "let g:terminal_color_3 = s:colors.orange.gui
  "let g:terminal_color_11 = s:colors.boldorange.gui

  "let g:terminal_color_4 = s:colors.darkblue.gui
  "let g:terminal_color_12 = s:colors.blue.gui

  "let g:terminal_color_5 = s:colors.darkpurple.gui
  "let g:terminal_color_13 = s:colors.purple.gui

  "" should be "cyan", but this is good enough
  "let g:terminal_color_6 = s:colors.darkblue.gui
  "let g:terminal_color_14 = s:colors.blue.gui

  "let g:terminal_color_7 = s:colors.grey2.gui
  "let g:terminal_color_15 = s:colors.bg.gui

  let g:terminal_color_0 = '#24292e'
  let g:terminal_color_8 = '#797979'

  let g:terminal_color_1 = '#a91b1b'
  let g:terminal_color_9 = '#e62000'

  let g:terminal_color_2 = '#00a237'
  let g:terminal_color_10 = '#96dab1'

  let g:terminal_color_3 = '#b68e00'
  let g:terminal_color_11 = '#b59f00'

  let g:terminal_color_4 = '#00529b'
  let g:terminal_color_12 = '#3981c6'

  let g:terminal_color_5 = '#ef61a2'
  let g:terminal_color_13 = '#ffb3ae'

  " should be "cyan", but this is good enough
  let g:terminal_color_6 = '#0186b4'
  let g:terminal_color_14 = '#03c4c8'

  let g:terminal_color_7 = '#feffff'
...
" diff (language)
call s:Col('diffFile',      'base0',    'grey2') | call s:Attr('diffFile', 'bold')
call s:Col('diffNewFile',   'base0',    'grey2') | call s:Attr('diffNewFile', 'bold')
call s:Col('diffIndexLine', 'base0',    'grey2') | call s:Attr('diffIndexLine', 'bold')
call s:Col('diffLine',      'purple',   'lightblue') | call s:Attr('diffLine', 'bold')
call s:Col('diffSubname',   'purple',   'lightblue')
...
" NERDTree
hi! link NERDTreeOpenable       ghBlue
hi! link NERDTreeClosable       ghRed
...
" coc
call s:Col('CocErrorSign',    'darkred', 'grey1')
call s:Col('CocWarningSign',  'boldorange',  'grey1')
call s:Col('CocInfoSign',     'boldorange',  'grey1')
call s:Col('CocHintSign',     'green',   'grey1')
